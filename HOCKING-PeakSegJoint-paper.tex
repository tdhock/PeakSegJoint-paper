...
\begin{figure}[b!]
  ...
  \caption{Demonstration of the PeakSegJoint heuristic segmentation
    algorithm. For a data set with $S=2$ samples (top 2 panels), and a
    bin size parameter of $\beta=2$, the algorithm proceeds as
    follows. First, }
