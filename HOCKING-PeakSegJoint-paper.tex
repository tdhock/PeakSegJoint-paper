...
the unsupervised joint peak detectors means that their articles did
not discuss time complexity \citep{MACS, HMCan, JAMM, PePr}.

\begin{center}
  \begin{tabular}{crrcc}
  Algorithm & Samples & Cell types & Time complexity & Learning \\
  \hline
  macs & 1 & 1 & ? & unsupervised \\
  hmcan.broad & 1 & 1 & ? & unsupervised \\
