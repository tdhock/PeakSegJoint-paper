...
\begin{figure}[b!]
  ...
  \vskip -0.8cm
  \caption{Performance of three segmentation algorithms on simulated
    ...
    data sets. Timings are shown in seconds, and the two measures of
    segmentation model accuracy are distance to true peak (in units of
    data points) and mean Poisson loss. }
  \label{fig:timings}
\end{figure}
